...
export const snsGuidesData: Record<string, SnsGuide> = {
    line: {
        ...
        steps: [
            {
                title: 'LINEアプリを開く',
                description: 'LINEアプリを開き、左下の「ホーム」タブから右上の友だち追加アイコンをタップします。',
        ...
        steps: [
            {
                ...
                description: 'アプリ（YT Studio）またはYouTube Studioにログインし、右上のプロフィールアイコンをタップします。',
            ...
            {
                title: 'ハンドル名をコピー',
                description: '「@」以降の文字列があなたのハンドル名ですので、右の鉛筆アイコンをタップします。',
    ...
    x: {
        ...
        steps: [
            ...
            {
                title: 'ユーザー名を確認',
                description: 'アカウント名の下に表示されている「@」から始まる文字列があなたのユーザー名です。',
    ...
    tiktok: {
        ...
        additionalInfo: 'TikTokユーザー名は後から変更できますが、頻繁に変更すると一時的に変更できなくなる場合があります。'
    },
    facebook: {
        platform: 'facebook',
        ...
        steps: [
            ...
            {
                title: 'URLを確認',
                description: 'プロフィール設定の一番下に「プロフィールリンクをコピー」とありますので、コピーせず「facebook.com/」の後に続く部分を入力下さい。',
                imageUrl: '/images/guides/facebook-step4.png'
            }
        ],
        additionalInfo: 'Facebookでは、プライバシー設定によって公開範囲が制限されている場合があります。'
    },
    pinterest: {
        platform: 'pinterest',
        ...
        additionalInfo: 'Pinterestではボードとプロフィールのどちらも共有できますが、ここではプロフィールのURLを入力してください。'
    },
    threads: {
        platform: 'threads',
        ...
        additionalInfo: 'ThreadsユーザーネームはInstagramと連携しており、Instagramで変更するとThreadsでも変更されます。'
    },
    note: {
        platform: 'note',
        platformName: 'note',
