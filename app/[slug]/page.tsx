    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <p style={{ color: "white", textAlign: "center", fontWeight: "800" }}>
                        シンプルにつながる、スマートにシェア。
                    </p>
                </div>
                ...
                <div style={{ padding: "1.5rem" }}>
                    ...
                    >
                        ...
                        {hasCompanyUrl && (
                            <a
                                href={((profile.user as unknown as { companyUrl?: string | null }).companyUrl) ||
                    ...
                    <div style={{ marginTop: "2rem", textAlign: "center" }}>
                        <Link href="/signup" style={{ color: "#2563EB", fontSize: "0.875rem", textDecoration: "none" }} className="hover:underline">
                            このサービスを使ってみる
                        </Link>
                ...
                <div className="bg-white rounded-xl max-w-md mx-auto mt-20 overflow-hidden shadow-lg">
                    <div className="p-6">
                        <div className="flex justify-between items-start">
                            <div></div>
                            <button className="text-2xl font-bold text-gray-500 hover:text-gray-700" id="close-modal">
                                &times;
                            </button>
                        </div>
