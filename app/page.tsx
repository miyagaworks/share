      ...
      <div className="relative flex flex-col md:flex-row h-screen">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center items-center p-8 md:p-16 bg-white">
          <div className="w-full max-w-md space-y-8">
            ...
            <div className="text-center mb-6">
              <Image src="/logo_share.svg" alt="Share Text" width={150} height={44} className="mx-auto" />
        ...
        <div className="hidden md:block md:w-1/2 bg-gradient-to-br from-blue-600 to-blue-800 relative overflow-hidden">
          ...
          <div className="absolute inset-0 flex items-center justify-center opacity-10">
            <Image src="/logo_blue.svg" alt="Share Logo Background" width={800} height={800} className="brightness-0 invert" />
          </div>
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center p-8">
            <div className="max-w-md text-center z-10">
              ...
              <p className="text-xl text-white/90 mb-8">
                SNSアカウントを一度に共有。<br />初めましての挨拶をもっとスムーズに。
              </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {useCases.map((useCase, index) => (
              <div key={index} className="bg-white rounded-xl overflow-hidden shadow-lg transition-all duration-300 hover:shadow-xl transform hover:-translate-y-1">
                <div className="p-6">
                  <div className="flex items-center mb-4">
                    <div className={`rounded-full p-3 mr-4 ${index % 2 === 0 ? 'bg-blue-100' : 'bg-blue-100'}`}>
                      <svg
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              <Link href="/legal/terms" className="text-sm text-gray-500 hover:text-blue-600">利用規約</Link>
              <Link href="/legal/privacy" className="text-sm text-gray-500 hover:text-blue-600">プライバシーポリシー</Link>
              <Link href="/support/contact" className="text-sm text-gray-500 hover:text-blue-600">お問い合わせ</Link>
            </div>
          </div>
        </div>
      </footer>
