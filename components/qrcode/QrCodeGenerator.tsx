...
import Link from 'next/link'; // Linkコンポーネントを使用（ベストプラクティス）
import { Button } from '@/components/ui/Button';
import { toast } from 'react-hot-toast';
import { FaMobile, FaLink, FaCopy } from 'react-icons/fa';
import { HiColorSwatch, HiEye, HiArrowLeft } from 'react-icons/hi'; // HiArrowLeftを追加
...
export function QrCodeGenerator({
  ...
  customBackUrl,
  initialQrCodeSlug,
  hideTitleHeader = false, // 追加: デフォルトは表示
