// components/subscription/SubscriptionWithTouchSeal.tsx
'use client';
...
export function SubscriptionWithTouchSeal() {
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <h2 className="text-2xl font-bold">タッチシール注文</h2>
    ...
    <div className="space-y-6">
      ...
      <Card className="p-6">
        <div className="flex items-center mb-4">
          ...
          <h3 className="text-lg font-semibold">タッチシール注文（オプション）</h3>
        </div>
        ...
        {!hasActivePlan ? (
          ...
          <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <p className="text-sm text-blue-700 mt-1">
              タッチシールの注文は法人管理者が行います。管理者にお問い合わせください。
            </p>
          </div>
        ) : (
          <>
            ...
            <div className="bg-blue-50 rounded-lg p-4 mb-6">
              <h4 className="font-medium text-blue-900 mb-2">タッチシールとは？</h4>
            ...
            <div className="flex justify-between items-center">
              <div>
                <p className="text-sm text-gray-600">配送料: ¥200（全国一律・クリックポスト）</p>
                <p className="text-xs text-gray-500">※価格は税抜表示です</p>
              </div>
      ...
      {/* 注文履歴セクション */}
      {canOrderTouchSeal && touchSealOrders.length > 0 && (
        <Card className="p-6">
          <div className="flex items-center mb-4">
            <CreditCard className="h-5 w-5 mr-2 text-blue-600" />
            <h3 className="text-lg font-semibold">タッチシール注文履歴</h3>
          </div>
