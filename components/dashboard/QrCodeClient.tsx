...
export function QrCodeClient({ profileUrl }: QrCodeClientProps) {
    ...
    // 選択された色のオブジェクトを取得
    const colorOption = QR_COLOR_OPTIONS.find(option => option.id === selectedColor) || QR_COLOR_OPTIONS[0];
        ...
        <div className="space-y-4">
                    ...
                    {QR_COLOR_OPTIONS.map((option) => (
                        <div key={option.id} className="flex flex-col">
                            <button
                                ...
                                style={{
                                    backgroundColor: option.id === 'black' ? '#000000' : option.id === 'darkGray' ? '#333333' : '#555555'
                                }}
                            >
                                <span
            ...
            <div className="flex justify-center space-x-4 mt-4">
                ...
                >
                    ...
                    <span className="font-bold">PNG</span><span style={{ fontSize: "0.75rem", margin: "0 -6px" }}>（画像用）</span>
                </Button>
                ...
                >
                    ...
                    <span className="font-bold">SVG</span><span style={{ fontSize: "0.75rem", margin: "0 -6px" }}>（印刷用）</span>
                </Button>
            </div>
