...
// Card コンポーネントのインポートを修正
// 注: DashboardCard コンポーネントを代わりに利用
...
export default function SubscriptionOverview({ userId }: SubscriptionOverviewProps) {
    ...
    // トライアル中
    if (trialEndDate && (!subscriptionData?.subscription || subscriptionData?.subscription?.status === 'trialing')) {
        return (
            <>
                    ...
                    <div className="flex items-start">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-sm text-gray-500 mb-4">
                                {new Date(trialEndDate).toLocaleDateString('ja-JP')}までトライアル期間をお楽しみください。
