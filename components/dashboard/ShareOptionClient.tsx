...
export function ShareOptionClient({ profileUrl }: ShareOptionClientProps) {
  ...
  return (
    <div className="space-y-4">
      <Button
        className="w-full flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-800 text-white h-[48px] text-base sm:text-sm"
      ...
      <div className="grid grid-cols-4 gap-2">
        <Button
          variant="outline"
          className="p-2 h-[48px] flex items-center justify-center text-base sm:text-sm"
