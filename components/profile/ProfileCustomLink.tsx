...
export function ProfileCustomLink({ link, mainColor }: ProfileCustomLinkProps) {
    return (
      <a
        ...
        className="flex items-center justify-between p-2 mb-2 rounded-4xl bg-white border border-gray-100 shadow-sm hover:shadow hover:translate-y-[-1px] transition-all duration-200"
      >
        {/* 左側のコンテンツエリア */}
