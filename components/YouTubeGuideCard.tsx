        ...
        <div className="px-6 py-4">
              ...
              <div className="mt-3 space-y-3 bg-gray-50 rounded-lg p-4">
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <span className="text-sm text-gray-600 ml-1 text-justify">
          ...
          <div className="mt-5 flex items-center space-x-3">
            <a
              ...
              className="inline-flex items-center px-4 py-3 bg-red-600 text-white text-sm font-medium rounded-md hover:bg-red-700 active:bg-red-800 transition-all duration-150 transform hover:scale-105 shadow-sm"
            >
            ...
            <button
              onClick={handleDismiss}
              className="text-sm ml-4 text-gray-500 hover:text-gray-700 underline"
            >
              後で見る
            </button>
          </div>
